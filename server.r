...
initProfile_server("init") # Initialize user profile (weight, etc)
...
profileGetter <- initProfile_server("init") # Get the reactive values from the userprofile and use them as parameters for the functions that need those informations
